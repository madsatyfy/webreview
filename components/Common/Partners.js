...
const Partners = () => {
  return (
    <>
      ...
      <h1 style={{textAlign:"center"}}>Looking For Getting Your Own Customized NFT's? <a href="/contact">Contact Us</a></h1>
        <div className="container">
          ...
          >            
            ...
            <SwiperSlide>
              <div className="partner-card">
                <a href="#" target="_blank" rel="noreferrer">
                  <img src="/images/partner/partner-7.png" alt="partner" />
                  {/* <img src="/images/partner/partner-hover-4.png" alt="partner" /> */}
                </a>
              </div>
            </SwiperSlide>
